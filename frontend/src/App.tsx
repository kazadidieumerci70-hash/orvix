  ...
  return (
    <main className="auth-page">
      <section className={`auth-panel auth-reference ${mode}`}>
        ...
        {mode === "register" && <>
          <button type="button" className="google-primary" onClick={() => setError("L’inscription Google sera activée après la configuration Google OAuth.")}><b>G</b><span>Continuer avec Google</span></button>
