  ...
  return (
    <div className="app-shell">
      <aside className={`sidebar ${mobileNav ? "open" : ""}`}>
        <div className="brand sidebar-brand"><span className="brand-mark">O</span><span>ORVIX</span></div>
  ...
  return (
    <main className="auth-page onboarding-page">
      <section className="onboarding-panel">
        <div className="brand auth-brand"><span className="brand-mark">O</span><span>ORVIX</span></div>
  ...
  return (
    <main className="auth-page">
      <section className={`auth-panel auth-reference ${mode}`}>
        ...
        {mode === "login" && <><div className="auth-divider"><span />ou continuer avec<span /></div><div className="social-auth"><button type="button" title="Bientôt disponible"><svg className="google-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="#4285F4" d="M21.35 12.27c0-.71-.06-1.4-.18-2.05H12v3.88h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.14c1.84-1.7 2.91-4.2 2.91-7.22Z"/><path fill="#34A853" d="M12 21.6c2.63 0 4.84-.87 6.45-2.36l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.7-1.72-5.47-4.03H3.28v2.53A9.74 9.74 0 0 0 12 21.6Z"/><path fill="#FBBC05" d="M6.53 13.68A5.85 5.85 0 0 1 6.22 12c0-.58.1-1.15.31-1.68V7.79H3.28A9.74 9.74 0 0 0 2.25 12c0 1.52.36 2.96 1.03 4.21l3.25-2.53Z"/><path fill="#EA4335" d="M12 6.29c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 3.36 14.63 2.4 12 2.4a9.74 9.74 0 0 0-8.72 5.39l3.25 2.53c.77-2.31 2.93-4.03 5.47-4.03Z"/></svg>Google</button><button type="button" title="Bientôt disponible"><b>●</b>Apple</button></div></>}
