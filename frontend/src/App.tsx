    ...
    <main className="auth-page">
      <section className={`auth-panel auth-reference ${mode}`}>
        ...
        <form onSubmit={submit} className="auth-form auth-reference-form">
          <div className="auth-input"><Phone size={20} /><input id="phone" aria-label="Numéro de téléphone" type="tel" value={phone} onChange={(event) => setPhone(event.target.value)} placeholder="Numéro de téléphone" autoComplete="tel" /></div>
